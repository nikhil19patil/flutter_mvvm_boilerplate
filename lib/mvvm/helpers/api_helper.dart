...
import 'package:illumine/mvvm/Helpers/loader_widget.dart';
import 'package:illumine/mvvm/Helpers/network_check.dart';
import 'package:illumine/mvvm/Helpers/pretty_json.dart';
    ...
    if (await NetworkCheck.isOnline(context!, showConnectivityError)) {
      ...
      await http
          .post(
            requestUri,
            body: jsonBody,
            headers: await _getHeaders(useAuth, apiVersion),
          )
...
// get request only for this call remove this and use above getRequest
  Future<dynamic> getDemoRequest(BuildContext? context, var requestUri,
      {bool showError: false,
        bool showMessage: false,
        bool showLoader: false,
        bool useAuth: true,
